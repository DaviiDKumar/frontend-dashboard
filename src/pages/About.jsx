...
import { ShieldCheck, MapPin, CreditCard, Zap, ArrowUpRight, Globe, Users, TrendingUp } from "lucide-react";
    ...
    <section className="relative bg-white py-20 md:py-32 px-4 md:px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              ...
              <p className="text-slate-400 text-sm font-medium leading-relaxed">
                Legally protected partnership with FreelanceWave. We ensure 100% compliance and secure data handling.
              </p>
            </div>
            {/* Visual glow */}
          ...
          {/* 02. EARNINGS CARD: Wide Horizontal */}
          <motion.div 
            variants={itemVariants}
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-blue-50 text-xs md:text-sm font-medium">Sector 10, Malviya Nagar. Full tech support & in-person onboarding.</p>
            </div>
          </motion.div>

          {/* 04. GROWTH CARD: Clean White */}
          <motion.div 
            variants={itemVariants}
